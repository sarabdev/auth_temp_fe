            ...
            <Grid item xs={12}>
              ...
              <FormControl sx={{ width: 400, mb: 6 }}>
                ...
                <FormControl sx={{ m: 3 }} component="fieldset" variant="standard">
                  <FormGroup>
                    <FormControlLabel
                      control={<Checkbox checked={companyDetails.selectedApplications.includes(applicationIDs["ems"])} onChange={handleChange} name="ems" />}
                      label="EMS"
                    />
                    <FormControlLabel
                      control={<Checkbox checked={companyDetails.selectedApplications.includes(applicationIDs["samodrei"])} onChange={handleChange} name="samodrei" />}
                      label="Samodrei"
                    />
                    <FormControlLabel
                      control={<Checkbox checked={companyDetails.selectedApplications.includes(applicationIDs["ascthem"])} onChange={handleChange} name="ascthem" />}
                      label="Ascthem"
                    />
                    <FormControlLabel
                      control={<Checkbox checked={companyDetails.selectedApplications.includes(applicationIDs["pharmacy_portal"])} onChange={handleChange} name="pharmacy_portal" />}
