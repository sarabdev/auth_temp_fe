      ...
      {!hidden ? (
        <Box sx={{ flex: 1, display: 'flex', position: 'relative', alignItems: 'center', justifyContent: 'center' }}>
          <ForgotPasswordIllustrationWrapper>
            <ForgotPasswordIllustration alt='reset-password-illustration' src={`/images/ascthem-logo.png`} />
          </ForgotPasswordIllustrationWrapper>
      ...
      >
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>Set Password</TypographyStyled>
            </Box>
            <form noValidate autoComplete='off' onSubmit={handleSubmit}>
              <FormControl sx={{ display: 'flex', marginBottom: 4 }}>
                <InputLabel htmlFor='auth-reset-password-v2-email'>Email</InputLabel>
                <OutlinedInput
                  autoFocus
                  label='Email'
                  value={values.email}
