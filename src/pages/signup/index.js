...
import { login, getMe ,register} from 'src/@fake-db/auth/jwtNew'
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              ...
              <Typography variant='body2'>Please register your account</Typography>
            </Box>
            {/* <Box sx={{ mb: 6 }}>
            ...
            <FormControl fullWidth sx={{mb:4}}>
                <InputLabel  error={Boolean(errors.username)}>
                  Username
                </InputLabel>
                <Controller
                  name='username'
              ...
              <Button fullWidth size='large' onClick={()=>router.replace('/login')}  sx={{ marginBottom: 7 }}>
                Login
              </Button>
